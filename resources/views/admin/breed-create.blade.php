            ...
            <div class="bg-white rounded-lg shadow-lg overflow-hidden mb-6">
                ...
                <div class="px-6 py-5 -mt-1">
                    <h1 class="text-2xl font-bold text-gray-800 flex items-center">
                        <i class="fas fa-plus-circle text-blue-500 mr-3"></i>Add New Breed
                    </h1>
                    <p class="text-gray-600 mt-2">Enter the details for the new breed below</p>
                </div>
            </div>
                ...
                <div class="p-6">
                    <form action="{{ route('breeds.store') }}" method="POST">
                        ...
                        <div class="mb-6 pb-4 border-b border-gray-200">
                            <div class="flex items-center">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-gray-500">Add a new breed to an existing species</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mb-6">
                            ...
                            <div class="flex items-center">
                                <div id="colorPreview" class="h-12 w-12 rounded-full bg-gray-200 flex items-center justify-center text-white font-bold mr-3">
                                    ?
                                </div>
                                <div id="speciesName" class="text-sm text-gray-500">
                                    Select a species to see its color
                                </div>
                            </div>
                        </div>
