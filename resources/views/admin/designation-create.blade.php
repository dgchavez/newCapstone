            ...
            <div class="bg-white rounded-lg shadow-lg overflow-hidden mb-6">
                ...
                <div class="px-6 py-5 -mt-1">
                    <h1 class="text-2xl font-bold text-gray-800 flex items-center">
                        <i class="fas fa-plus-circle text-blue-500 mr-3"></i>Add Designation
                    </h1>
                    <p class="text-gray-600 mt-2">Create a new designation for veterinarians</p>
                </div>
            </div>
                        ...
                        <div class="mb-6 pb-4 border-b border-gray-200">
                            <div class="flex items-center">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-gray-500">Provide information about the new designation</p>
                                </div>
                            </div>
                        </div>
