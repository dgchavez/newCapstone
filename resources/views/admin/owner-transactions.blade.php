<x-app-layout>
    ...
    <div class="container mx-auto p-8 bg-gray-50 shadow-lg rounded-xl">
        <a href="{{ route('owners.profile-owner', ['owner_id' => $owner_id]) }}" class="bg-yellow-500 text-white p-2 rounded-md hover:bg-yellow-600 transition-colors duration-300">
            Back to Profile
        </a>
        <div class="bg-white p-6 rounded-lg shadow-xl">
            ...
            <!-- Search and Filters -->
            <div class="mb-6">
                <form method="GET" action="{{ route('owner.transactions', ['owner_id' => $owner->owner_id]) }}" class="space-x-4" id="filterForm">
                    <!-- Search Input -->
    ...
    function resetFilters() {
        ...
        window.location.href = "{{ route('owner.transactions', ['owner_id' => $owner->owner_id]) }}";
    }
