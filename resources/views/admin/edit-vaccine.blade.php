<x-app-layout>
            ...
            <div class="bg-white rounded-lg shadow-lg overflow-hidden mb-6">
                ...
                <div class="px-6 py-5 -mt-1">
                    <h1 class="text-2xl font-bold text-gray-800 flex items-center">
                        <i class="fas fa-edit text-blue-500 mr-3"></i>Edit Vaccine
                    </h1>
                    <p class="text-gray-600 mt-2">Update the details for this vaccine</p>
                </div>
            </div>
                        ...
                        <div class="mb-6 pb-4 border-b border-gray-200">
                            <div class="flex items-center">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-gray-500">Editing: {{ $vaccine->vaccine_name }}</p>
                                </div>
                            </div>
                        </div>
    ...
    <script>
        ...
        const originalName = "{{ $vaccine->vaccine_name }}";
        const originalDescription = "{{ $vaccine->description }}";
        
        // Function to reset the form to original values
        function resetForm() {
            document.getElementById('vaccine_name').value = originalName;
