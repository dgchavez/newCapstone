    ...
    <div class="max-w-4xl mx-auto bg-white p-8 rounded-lg shadow-lg">
        ...
        <div class="mb-6 text-center">
            @if ($user->profile_image)
                ...
                <form action="{{ route('users.delete-image', $user->user_id) }}" method="POST" class="mt-4">
                    @csrf
                    @method('DELETE')
      ...
      <!-- User Edit Form -->
      <form action="{{ route('users.profile-update', $user->user_id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
