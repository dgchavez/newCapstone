<x-app-layout>
            ...
            <div class="bg-white rounded-lg shadow-lg overflow-hidden mb-6">
                ...
                <div class="px-6 py-5 -mt-1">
                    <h1 class="text-2xl font-bold text-gray-800 flex items-center">
                        <i class="fas fa-plus-circle text-blue-500 mr-3"></i>Add Transaction Subtype
                    </h1>
                    <p class="text-gray-600 mt-2">Create a new transaction subtype for an existing transaction type</p>
                </div>
            </div>
                ...
                <div class="p-6">
                    <form action="{{ route('transaction-subtypes.store') }}" method="POST">
                        ...
                        <div class="mb-6 pb-4 border-b border-gray-200">
                            <div class="flex items-center">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-gray-500">Subtypes help categorize transactions more specifically</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mb-6">
                            ...
                            <div class="flex items-center">
                                <span id="colorPreview" class="px-3 py-1 text-sm inline-flex items-center rounded-full text-white bg-gray-300 mr-3">
                                    Select a type
                                </span>
                                <div id="typeName" class="text-sm text-gray-500">
                                    Select a transaction type to see its color
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mt-8 flex items-center justify-between">
                            ...
                            <div class="flex gap-3">
                                ...
                                >
                                    ...
                                    <span>Add Transaction Subtype</span>
                                </button>
                            </div>
                        </div>
                    </form>
    ...
    <script>
        ...
        function updateColorPreview() {
            ...
            preview.classList.remove('bg-gray-300');
            ...
            if (typeSelect.value) {
                ...
                // Default if no type selected
                preview.classList.add('bg-gray-300');
                preview.innerText = 'Select a type';
                typeNameElement.innerText = 'Select a transaction type to see its color';
            }
        }
