<header class="sticky top-4 inset-x-0 before:absolute before:inset-0 before:max-w-[66rem] before:mx-2 before:lg:mx-auto before:rounded-[26px] before:border before:border-gray-200 dark:border-neutral-700 after:absolute after:inset-0 after:-z-[1] after:max-w-[66rem] after:mx-2 after:lg:mx-auto after:rounded-[26px] after:bg-white dark:bg-neutral-900 flex flex-wrap md:justify-start md:flex-nowrap z-50 w-full">
  ...
  <a class="flex-none" href="#" aria-label="Brand">
    <img class="w-16 h-16 rounded-full object-cover  hover:scale-105 transition-transform duration-400" src="{{ asset('assets/1.jpg') }}" alt="Brand Image">
  </a>
  ...
  <!-- Collapse -->
  <div id="hs-header-classic" class=" hover:scale-105hs-collapse hidden overflow-hidden transition-all duration-300 basis-full grow md:block" aria-labelledby="hs-header-classic-collapse">
    <div class="overflow-hidden overflow-y-auto max-h-[75vh] [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-track]:bg-gray-100 [&::-webkit-scrollbar-thumb]:bg-gray-300 dark:[&::-webkit-scrollbar-track]:bg-neutral-700 dark:[&::-webkit-scrollbar-thumb]:bg-neutral-500">
      <div class="py-2 md:py-0 flex flex-col md:flex-row md:items-center md:justify-end gap-0.5 md:gap-1">
        <a class="p-2 flex items-center text-sm text-gray-800 hover:text-green-500 focus:outline-none focus:text-gray-500 dark:text-neutral-200 dark:hover:text-greem500 dark:focus:text-neutral-500" href="#" aria-current="page">
        ...
        <a class="p-2 flex items-center text-sm text-gray-800 hover:text-green-500 focus:outline-none focus:text-gray-500 dark:text-neutral-200 dark:hover:text-greem500 dark:focus:text-neutral-500" href="#team">
      ...
      <a class=" p-2 flex items-center text-sm text-gray-800 hover:text-green-500 focus:outline-none focus:text-gray-500 dark:text-neutral-200 dark:hover:text-greem500 dark:focus:text-neutral-500" href="#features">
        <svg class="shrink-0 size-4 me-3 md:me-2 block md:hidden " xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M19 21v-2a4 4 0 0 0-4-4H9a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>
       Features
    </a>


    <a class="p-2 flex items-center text-sm text-gray-800 hover:text-green-500 focus:outline-none focus:text-gray-500 dark:text-neutral-200 dark:hover:text-greem500 dark:focus:text-neutral-500" href="#gallery">
      <svg class="shrink-0 size-4 me-3 md:me-2 block md:hidden" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M19 21v-2a4 4 0 0 0-4-4H9a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>
     Gallery
  </a>
        ...
        <div class="relative flex flex-wrap items-center gap-x-1.5 md:ps-2.5  md:ms-1.5 before:block before:absolute before:top-1/2 before:-start-px before:w-px before:h-4 before:bg-gray-300 before:-translate-y-1/2 dark:before:bg-neutral-700">
          <a class="p-2 flex items-center text-sm text-gray-800 hover:text-green-500 focus:outline-none focus:text-gray-500 dark:text-neutral-200 dark:hover:text-greem500 dark:focus:text-neutral-500" href="/login">
        ...
        <div class="relative flex flex-wrap items-center gap-x-1.5 md:ps-2.5  md:ms-1.5 before:block before:absolute before:top-1/2 before:-start-px before:w-px before:h-4 before:bg-gray-300 before:-translate-y-1/2 dark:before:bg-neutral-700">
            <a class="p-2 flex items-center text-sm text-gray-800 hover:text-green-500 focus:outline-none focus:text-gray-500 dark:text-neutral-200 dark:hover:text-greem500 dark:focus:text-neutral-500" href="/register">
              <svg class="shrink-0 size-4 me-3 md:me-2" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M19 21v-2a4 4 0 0 0-4-4H9a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>
              <b>Register</b>
            </a>
          </div>
