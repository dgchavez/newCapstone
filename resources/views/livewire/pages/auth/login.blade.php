                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input wire:model="form.email" id="email" 
                               class="block w-full pl-10 pr-3 py-2 text-gray-900 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 transition duration-200" 
                               type="text" 
                               name="email" 
                               required 
                               autofocus 
                    ...
                    <div class="relative">
                        ...
                        <div x-data="{ showPassword: false }">
                            <input wire:model="form.password" id="password" 
                                   ...
                                   class="block w-full pl-10 pr-12 py-2 text-gray-900 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 transition duration-200" 
                                   name="password" 
                                   required 
