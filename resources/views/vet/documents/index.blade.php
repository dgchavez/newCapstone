...
<div class="py-6">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-4 hover:shadow-md transition-shadow duration-200">
                <div class="flex items-start justify-between">
                    ...
                    <div class="flex items-center space-x-2">
                        ...
                        <button type="button" 
                                onclick="confirmDocumentDelete({{ $document->id }}, '{{ $document->title }}')" 
            ...
            <div class="col-span-1 md:col-span-2 lg:col-span-3 py-12">
                <div class="flex flex-col items-center justify-center text-center">
                    ...
                    <p class="text-gray-500 mb-4">You haven't uploaded any documents yet or no documents match your filters.</p>
                    <button 
                        onclick="document.getElementById('uploadModal').classList.remove('hidden')"
                        class="inline-flex items-center px-4 py-2 bg-green-600 hover:bg-green-700 text-white text-sm font-medium rounded-md transition duration-150 ease-in-out">
                        <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <!-- Upload Modal -->
        <div id="uploadModal" class="hidden fixed inset-0 z-50 overflow-y-auto bg-gray-500 bg-opacity-75 backdrop-blur-sm flex items-center justify-center">
            <div class="bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all w-full max-w-lg mx-auto">
...
<div id="deleteModal" class="hidden fixed inset-0 z-50 overflow-y-auto bg-gray-500 bg-opacity-75 backdrop-blur-sm flex items-center justify-center">
    <div class="bg-white rounded-lg overflow-hidden shadow-xl transform transition-all max-w-lg w-full mx-auto">
        <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
            <div class="sm:flex sm:items-start">
                ...
                <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                    ...
                    <div class="mt-2">
                        <p class="text-sm text-gray-500">
                            Are you sure you want to delete "<span id="documentTitle" class="font-medium"></span>"? This action cannot be undone.
                        </p>
                    </div>
                </div>
            </div>
...
<script>
    function confirmDocumentDelete(documentId, documentTitle) {
        ...
        deleteForm.action = "{{ route('vet.documents.destroy', ':id') }}".replace(':id', documentId);
