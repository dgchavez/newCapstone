        ...
        <div class="bg-gradient-to-r from-green-800 to-green-600 rounded-xl shadow-lg p-8 mb-8 relative overflow-hidden">
            <div class="absolute inset-0 opacity-10">
                <svg class="w-full h-full" viewBox="0 0 100 100" preserveAspectRatio="none">
                    <path d="M0,0 L100,0 L100,100 L0,100 Z" fill="url(#report-pattern)" />
                </svg>
                <defs>
                    <pattern id="report-pattern" width="10" height="10" patternUnits="userSpaceOnUse">
            ...
            <div class="relative z-10 flex items-center justify-between">
                <div>
                    <h1 class="text-3xl font-bold text-white mb-2">Generate Reports</h1>
                    <p class="text-blue-100">Generate detailed reports for your veterinary practice</p>
                </div>
