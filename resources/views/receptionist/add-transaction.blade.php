        ...
        <div class="bg-white shadow-xl rounded-xl p-8 border-t-4 border-green-500">
            ...
            <div class="bg-gradient-to-r from-green-800 to-green-600 rounded-xl shadow-md p-6 -mt-8 -mx-8 mb-8 relative overflow-hidden">
                ...
                <div class="relative z-10">
                    ...
                    <p class="text-blue-100 mt-2">For Owner: {{ $owner->user->complete_name }}</p>
                </div>
            </div>
            ...
            <form action="{{ route('owner.addTransaction', $owner_id) }}" method="POST" class="space-y-6">
                ...
                <div>
                    ...
                    <div class="relative rounded-md shadow-sm">
                        ...
                        <select 
                            name="animal_id" 
                            id="animal_id" 
                            class="pl-10 block w-full p-3 border border-gray-300 rounded-lg shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                        >
                ...
                <div hidden>
                    ...
                    <select name="status" id="status" class="w-full p-3 border border-gray-300 rounded-lg shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500" required>
                ...
                <div class="flex items-center justify-between space-x-4 pt-4 mt-6 border-t border-gray-200">
                    ...
                    <button
                        type="submit"
                        class="inline-flex items-center px-5 py-3 bg-blue-600 text-white font-medium rounded-lg hover:bg-blue-700 transition-all duration-300 shadow-md"
                    >
