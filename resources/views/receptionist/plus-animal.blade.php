<x-app-layout>
    <div class="container mx-auto px-4 py-8">
        ...
        <!-- Animal Form -->
        <form action="{{ route('rec-animals.store') }}" method="POST" enctype="multipart/form-data" class="max-w-4xl mx-auto bg-white dark:bg-neutral-800 shadow-lg rounded-lg p-6">
            @csrf
