<x-app-layout>
    ...
    <div class="max-w-4xl mx-auto bg-white p-8 rounded-lg shadow-lg">
      ...
      <!-- User Edit Form -->
      <form action="{{ route('rec.owner-form-update', $user->user_id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        ...
        <div class="mb-6">
            ...
            <div class="space-y-6">
                ...
                <a href="{{ route('owners.profile-owner', ['owner_id' => $user->owner->owner_id]) }}" class="bg-gray-500 text-white p-2 rounded-md hover:bg-gray-600 transition-colors duration-300">
                    <x-primary-button class="bg-blue-600 hover:bg-blue-700 focus:ring-4 focus:ring-blue-300 focus:outline-none text-white font-semibold rounded-lg px-6 py-3 shadow-md transition duration-300 ease-in-out transform hover:scale-105">
                        {{ __('CANCEL') }}
                    </x-primary-button><br>
                </a>
