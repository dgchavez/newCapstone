            ...
            <div class="bg-white rounded-lg shadow-lg overflow-hidden">
                <div class="p-6">
                    ...
                    <div class="flex items-center text-sm text-gray-500 mb-6">
                        ...
                        <span class="font-medium text-gray-700">Add New Breed</span>
                    </div>
                    ...
                    <form action="{{ route('newbreeds.store') }}" method="POST" class="space-y-6">
                        @csrf
                        ...
                        <div class="flex space-x-4 pt-4">
                            ...
                            <button type="submit" class="inline-flex items-center px-5 py-3 bg-blue-600 text-white rounded-lg shadow-md hover:bg-blue-700 focus:outline-none transition duration-200">
                                <i class="fas fa-save mr-2"></i> Save Breed
                            </button>
                        </div>
                    </form>
                </div>
