    ...
    <div class="bg-gradient-to-r from-green-800 to-green-600 shadow-xl">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 relative">
            ...
            <div class="relative z-10 flex flex-col md:flex-row justify-between items-center">
                <div>
                    <h1 class="text-3xl font-bold text-white">Veterinary Technicians</h1>
                    <p class="text-blue-100 mt-1">Manage technician information and records</p>
                </div>
                <div class="mt-4 md:mt-0">
                    <a href="{{ route('rec-technicians.create') }}" class="inline-flex items-center px-5 py-3 bg-white text-green-700 rounded-lg shadow-md hover:bg-green-50 transition-all duration-300">
                            ...
                            <tr>
                                <td colspan="5" class="px-6 py-10 text-center text-gray-500">
                                    <div class="flex flex-col items-center justify-center">
                                        ...
                                        <p class="text-sm text-gray-400 mt-1">Get started by adding a new technician.</p>
                                    </div>
                                </td>
                            </tr>
                        @endforelse
