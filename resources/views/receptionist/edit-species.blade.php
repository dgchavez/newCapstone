            ...
            <div class="bg-white rounded-lg shadow-lg overflow-hidden">
                <div class="p-6">
                    ...
                    <div class="flex items-center text-sm text-gray-500 mb-6">
                        ...
                        <span class="font-medium text-gray-700">Edit Species: {{ $species->name }}</span>
                    </div>
                    ...
                    <div class="mb-6 flex items-center p-4 bg-blue-50 rounded-lg border border-blue-200">
                        <div class="flex-shrink-0 mr-4">
                            <div class="h-16 w-16 rounded-full 
                                @php
                                    ...
                                    $hash = hexdec(substr(md5($species->name), 0, 8));
                        ...
                        <div>
                            <h3 class="text-lg font-medium text-gray-900">Editing Species</h3>
                            <p class="text-sm text-gray-600">
                                You are currently editing the species "{{ $species->name }}". 
                                Any changes will affect all breeds associated with this species.
                            </p>
                        </div>
                    </div>

                    <form action="{{ route('newspecies.updates', ['species' => $species->id]) }}" method="POST" class="space-y-6">
                        @csrf
                        @method('PUT')
